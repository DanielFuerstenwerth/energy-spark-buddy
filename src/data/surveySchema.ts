...
export const QUESTION_REGISTRY: Record<string, { displayId: string; dbColumn: string; uiNumber?: string }> = {
  ...
  "ggvProjectType": { displayId: "2-GGV-ProjectType", dbColumn: "ggv_project_type", uiNumber: "2.3" },
  "ggvPvSizeKw": { displayId: "2-GGV-PvSizeKw", dbColumn: "ggv_pv_size_kw", uiNumber: "2.4" },
  "ggvPartyCount": { displayId: "2-GGV-PartyCount", dbColumn: "ggv_party_count", uiNumber: "2.5" },
  "ggvBuildingType": { displayId: "2-GGV-BuildingType", dbColumn: "ggv_building_type", uiNumber: "2.7" },
  "ggvBuildingCount": { displayId: "2-GGV-BuildingCount", dbColumn: "ggv_building_count", uiNumber: "2.6" },
  "ggvAdditionalInfo": { displayId: "2-GGV-AdditionalInfo", dbColumn: "ggv_additional_info", uiNumber: "2.8" },
  "mieterstromPvSizeKw": { displayId: "2-MS-PvSizeKw", dbColumn: "mieterstrom_pv_size_kw", uiNumber: "2.9" },
  "mieterstromPartyCount": { displayId: "2-MS-PartyCount", dbColumn: "mieterstrom_party_count", uiNumber: "2.10" },
  "mieterstromBuildingType": { displayId: "2-MS-BuildingType", dbColumn: "mieterstrom_building_type", uiNumber: "2.11" },
  "mieterstromAdditionalInfo": { displayId: "2-MS-AdditionalInfo", dbColumn: "mieterstrom_additional_info", uiNumber: "2.12" },
  "projectLocations": { displayId: "2-ProjectLocations", dbColumn: "project_locations", uiNumber: "2.13" },
  // Section 3: Planung Allgemein
  "planningStatus": { displayId: "3-PlanningStatus", dbColumn: "planning_status", uiNumber: "3.1" },
  "ggvOrMieterstromDecision": { displayId: "3-GgvOrMsDecision", dbColumn: "ggv_or_mieterstrom_decision", uiNumber: "3.2" },
  "ggvDecisionReasons": { displayId: "3-GGV-DecisionReasons", dbColumn: "ggv_decision_reasons", uiNumber: "3.3" },
  "mieterstromDecisionReasons": { displayId: "3-MS-DecisionReasons", dbColumn: "mieterstrom_decision_reasons", uiNumber: "3.4" },
  "implementationApproach": { displayId: "3-ImplApproach", dbColumn: "implementation_approach", uiNumber: "3.5" },
  "challenges": { displayId: "3-Challenges", dbColumn: "challenges", uiNumber: "3.6" },
  "vnbRejectionResponse": { displayId: "3-RejectionResponse", dbColumn: "vnb_rejection_response", uiNumber: "3.7" },
