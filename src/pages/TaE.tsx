...
const TaE = () => {
  const [activeCategory, setActiveCategory] = useState("TaE");
  const [selectedVnb, setSelectedVnb] = useState<{ id: string; name: string } | null>(null);
  const mapRef = useRef<MapContainerHandle>(null);
  const { scoreData, loading, error } = useMapData("TaE");
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main id="main-content" className="flex-grow bg-background">
        <div className="container mx-auto px-6 py-8">
          <h1 className="text-3xl font-bold mb-6">Teilhabe an Energiewende (TaE)</h1>
